...
private:
    ...
    bool hit=false; // The hit status of the shooter
...
public:
    ...
    Bullet shoot(int dist)
    {
        // shoot a bullet
        return Bullet(head.getX()+dist, head.getY());
    }
    ...
    double get_center_x()
    {
        // return the x coordinate of the center of the shooter
        return (head.getX()+body.getX())/2;
    }
    double get_center_Y()
    {
        // return the y coordinate of the center of the shooter
        return (head.getY()+body.getY())/2;
    }
    bool& shooter_hit()
    {
        // return the hit status of the shooter
        return hit;
    }
